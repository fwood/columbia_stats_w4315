...
\frame[t] {
 ...
 \begin{itemize}
\item Function to minimize w.r.t. $b_0, b_1$
...
\frame[t] {
 ...
 $$\left[\begin{array}{c} Y_1 \\Y_2 \\ \vdots \\ Y_n \end{array} \right] =  \left[\begin{array}{cc} X_1 & 1\\X_2 & 1\\ {\vdots} \\ X_n & 1\end{array} \right]\left[ \begin{array}{cc}b_1 \\ b_0
 \end{array}\right]$$
...
&=& \Ave{[\hat \theta -\Ave{\hat \theta}]^2} + 2\Ave{[\Ave{\hat \theta}-\theta][\hat \theta - \Ave{\hat \theta}]} +\\
& & \qquad \Ave{[\Ave{\hat \theta} - \theta]^2} \\
